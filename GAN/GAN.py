...
class Generator(nn.Module):
    def __init__(self, seq_len, n_features, hidden_dim=128, dropout_rate=dropout_rate):
...
class Discriminator(nn.Module):
    def __init__(self, seq_len, n_features, hidden_dim=None, dropout_rate=dropout_rate):
